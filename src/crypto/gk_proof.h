...
//
// Proof size: 18 points x 32 + 7 scalars x 32 = 800 bytes.
// Q has 6 elements (m=0..5) to commit all non-leading polynomial coefficients;
// the degree-6 leading coefficient (= D[l] = r*G) is absorbed into scalar f.
//
