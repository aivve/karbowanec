...
public: 
  ...
  virtual size_t addOutput(uint64_t amount, const AccountPublicAddress& to, uint64_t unlockTime = 0) = 0;
  virtual size_t addOutput(uint64_t amount, const std::vector<AccountPublicAddress>& to, uint32_t requiredSignatures, uint64_t unlockTime = 0) = 0;
  virtual size_t addOutput(uint64_t amount, const KeyOutput& out, uint64_t unlockTime = 0) = 0;
  virtual size_t addOutput(uint64_t amount, const MultisignatureOutput& out, uint64_t unlockTime = 0) = 0;
