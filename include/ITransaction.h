...
public:
  ...
  virtual uint64_t getOutputUnlockTime(size_t index) const = 0;
...
public: 
  ...
  virtual size_t addOutput(uint64_t amount, const AccountPublicAddress& to, uint32_t unlockHeight = 0) = 0;
  virtual size_t addOutput(uint64_t amount, const std::vector<AccountPublicAddress>& to, uint32_t requiredSignatures, uint32_t unlockHeight = 0) = 0;
  virtual size_t addOutput(uint64_t amount, const KeyOutput& out, uint32_t unlockHeight = 0) = 0;
  virtual size_t addOutput(uint64_t amount, const MultisignatureOutput& out, uint32_t unlockHeight = 0) = 0;
